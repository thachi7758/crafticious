 ...
 * Slug: pet-ecommerce-store/search-product
 * Categories: pet-ecommerce-store, search-product
 */
?>
...
<!-- wp:paragraph -->
<p><?php esc_html_e('No products were found matching your selection.','pet-ecommerce-store'); ?></p>
<!-- /wp:paragraph -->

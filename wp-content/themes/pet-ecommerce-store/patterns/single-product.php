 ...
 * Slug: pet-ecommerce-store/single-product
 * Categories: pet-ecommerce-store, single-product
 */
?>
...
<h2 class="wp-block-heading has-text-align-left has-large-font-size" style="margin-top:1rem;margin-bottom:1rem"><?php esc_html_e('Related Products','pet-ecommerce-store'); ?></h2>
<!-- /wp:heading -->
